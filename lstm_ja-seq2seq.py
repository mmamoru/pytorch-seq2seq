...
start = 18
for i in range(start,+start+len(bun[:9])):
    print(bun[i])

# voc2count = list(voc2.word2count.items())
# voc2count = sorted(voc2count,key=lambda x:x[1],reverse=True)
# start=80
# num=10
